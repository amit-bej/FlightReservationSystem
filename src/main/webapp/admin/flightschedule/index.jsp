...
<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">  
                    <a class="sidebar-link ps-md-3" href="#"><i class="fas fa-calendar-alt"></i> Flight Schedule</a>
                </li>  
                <li>  
  ...
  <i class="fas fa-plus-circle"></i> Add Flight Schedule
    ...
    <tr>
      ...
      <td><a class="text-decoration-none" href="updateschedule.jsp?flightID=<%=resultSet.getString("FLIGHT_ID") %>"><i class="fas fa-pencil-alt"></i> Edit</a>&nbsp;&nbsp;<a class="text-danger text-decoration-none" href="delete.jsp?flightID=<%=resultSet.getString("FLIGHT_ID") %>"><i class="fas fa-trash-alt"></i> Delete</a></td>
    </tr>
