...
<head>
  <meta charset="UTF-8">
  <title>Welcome to Project Airlines</title>
...
<section class='login' id='login'>
  <div class='head'>
  <h1 class='company'>Project Airlines</h1>
  </div>
